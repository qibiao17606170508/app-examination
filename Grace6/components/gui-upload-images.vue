<template>
  <view class="gui-flex gui-rows gui-wrap">
    ...
    <view class="gui-add-list-items gui-flex gui-columns gui-justify-content-center gui-align-items-center gui-bg-gray gui-dark-bg-level-6" @tap="addImg" v-if="imgLists.length < maxFileNumber" :style="{ borderRadius: borderRadius }">
